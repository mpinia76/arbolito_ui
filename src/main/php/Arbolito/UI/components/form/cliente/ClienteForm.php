...
namespace Arbolito\UI\components\form\cliente;

use Arbolito\UI\components\filter\model\UIClienteCriteria;

use Arbolito\UI\service\finder\ClienteFinder;
...
use Arbolito\Core\model\Sexo;

use Arbolito\Core\model\TipoDocumento;
...
class ClienteForm extends Form{
    ...
    public function getTipoClienteFinderClazz(){

        return get_class( new TipoClienteFinder() );

    }


    public function getTiposCliente(){
        $criteria = new UITipoClienteCriteria();

        $criteria->addOrder("nombre", "ASC");
        $tiposCliente = UIServiceFactory::getUITipoClienteService()->getList( $criteria);
	...
	public function getTiposDocumento(){
		...
		return ArbolitoUIUtils::localizeEntities(TipoDocumento::getItems());
	}
