...
namespace Arbolito\UI\components\form\pedido;

use Arbolito\UI\components\filter\model\UIProveedorCriteria;

use Arbolito\UI\service\finder\ProveedorFinder;

use Arbolito\UI\service\finder\ClienteFinder;

use Arbolito\UI\service\finder\TipoProductoFinder;

use Arbolito\UI\service\finder\MarcaProductoFinder;

use Arbolito\UI\service\finder\ProductoFinder;
...
class PedidoForm extends Form{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		foreach ($productos as $producto) {
			...
			//$xtpl->assign("logo", ArbolitoUIUtils::getImagenProducto($producto));
