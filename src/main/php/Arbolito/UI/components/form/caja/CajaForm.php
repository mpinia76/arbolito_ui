...
namespace Arbolito\UI\components\form\caja;

use Arbolito\UI\service\finder\SucursalFinder;

use Arbolito\UI\service\finder\EmpleadoFinder;

use Arbolito\UI\components\filter\model\UIEmpleadoCriteria;

use Arbolito\UI\components\filter\model\UISucursalCriteria;
...
//		}
	...
	public function getFechaEditable(){
		return ArbolitoUIUtils::isAdminLogged();
	}
