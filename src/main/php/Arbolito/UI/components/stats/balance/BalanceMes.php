...
class BalanceMes extends RastyComponent{
    ...
    protected function parseXTemplate(XTemplate $xtpl){
        ...
        /*$xtpl->assign("gastos",  ArbolitoUIUtils::formatMontoToView($balance["gastos"]) );
        $xtpl->assign("pagos",  ArbolitoUIUtils::formatMontoToView($balance["pagos"]) );*/
        $xtpl->assign("ventas",  ArbolitoUIUtils::formatMontoToView($saldos["ventas"]) );
        //$xtpl->assign("comisiones",  ArbolitoUIUtils::formatMontoToView($balance["comisiones"]) );
