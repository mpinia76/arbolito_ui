...
namespace Arbolito\UI\components\boxes\pedido;
...
class PedidoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", ArbolitoUIUtils::formatMontoToView( $pedido->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getPedido()->getObservaciones() );
		$xtpl->assign( "fechaHora", ArbolitoUIUtils::formatDateTimeToView($this->getPedido()->getFechaHora()) );

		$xtpl->assign( "estado", $this->localize( EstadoPedido::getLabel( $pedido->getEstado()) ) );

		if( $pedido->isRecibido() ){
			$recibido = ArbolitoUIUtils::formatDateTimeToView($this->getPedido()->getFechaHoraRecibido());
		...
		$xtpl->assign( "total", ArbolitoUIUtils::formatMontoToView( $pedido->getMonto() ) );
