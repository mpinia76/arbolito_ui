...
namespace Arbolito\UI\components\boxes\presupuesto;
...
class PresupuestoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", ArbolitoUIUtils::formatMontoToView( $this->getPresupuesto()->getMonto() ) );



		$xtpl->assign( "observaciones", $this->getPresupuesto()->getObservaciones() );
		$xtpl->assign( "fecha", ArbolitoUIUtils::formatDateTimeToView($this->getPresupuesto()->getFecha()) );
