...
namespace Arbolito\UI\components\boxes\caja;
...
class CajaBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($caja )){
			...
			$xtpl->assign("recaudacion",  ArbolitoUIUtils::formatMontoToView($caja->getRecaudacion()) );
			$xtpl->assign("horaApertura",  ArbolitoUIUtils::formatTimeToView($caja->getHoraApertura()) );
			$xtpl->assign("fecha",  ArbolitoUIUtils::formatDateToView($caja->getFecha()) );

			$ventas_online_ctacte = UIServiceFactory::getUIVentaService()->getTotalesCajaVentasOnlineCtaCte($caja);
			$xtpl->assign("ventas_online_ctacte",  ArbolitoUIUtils::formatMontoToView( $ventas_online_ctacte ) );
			...
			if( $this->getDetalle() ){
				...
				foreach ($totales as $total) {
					...
					$xtpl->assign("importe",  ArbolitoUIUtils::formatMontoToView($importe) );
