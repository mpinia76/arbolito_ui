...
namespace Arbolito\UI\components\boxes\banco;
...
class BancoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($banco )){
			...
			$xtpl->assign("saldo",  ArbolitoUIUtils::formatMontoToView($banco->getSaldo()) );
			$xtpl->assign("saldoInicial",  ArbolitoUIUtils::formatMontoToView($banco->getSaldoInicial()) );
