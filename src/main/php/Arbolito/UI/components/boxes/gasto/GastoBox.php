...
namespace Arbolito\UI\components\boxes\gasto;
...
class GastoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", ArbolitoUIUtils::formatMontoToView( $this->getGasto()->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getGasto()->getObservaciones() );
		$xtpl->assign( "fecha", ArbolitoUIUtils::formatDateTimeToView($this->getGasto()->getFecha()) );
		$xtpl->assign( "fechaVencimiento", ArbolitoUIUtils::formatDateTimeToView($this->getGasto()->getFechaVencimiento()) );
