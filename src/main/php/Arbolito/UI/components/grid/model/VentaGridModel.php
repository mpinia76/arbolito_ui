...
use Arbolito\UI\components\grid\formats\GridEstadoVentaFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	protected function initModel() {
        ...
        $column = GridModelBuilder::buildColumn( "nroComprobante", "venta.nroComprobante", 20, EntityGrid::TEXT_ALIGN_LEFT );
        $this->addColumn( $column );
	...
	public function getRowStyleClass($item){
		...
		return ArbolitoUIUtils::getEstadoVentaCss($item->getEstado());
	...
	public function getHeaderContent(){
		...
		return 'Bruto: <strong>'.ArbolitoUIUtils::formatMontoToView($service->getTotales($filter->getCriteria())).'</strong> Neto: <strong>'.ArbolitoUIUtils::formatMontoToView($service->getGanancias($filter->getCriteria())).'</strong>';*/
	}
