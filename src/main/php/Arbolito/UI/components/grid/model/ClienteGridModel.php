...
class ClienteGridModel extends EntityGridModel{
	...
	protected function initModel() {
        ...
        $column = GridModelBuilder::buildColumn( "nroSocio", "cliente.nroSocio", 30, EntityGrid::TEXT_ALIGN_RIGHT ) ;
        $this->addColumn( $column );

		$column = GridModelBuilder::buildColumn( "nombre", "cliente.nombre", 30, EntityGrid::TEXT_ALIGN_LEFT ) ;
		$this->addColumn( $column );

        $column = GridModelBuilder::buildColumn( "tipoCliente", "cliente.tipoCliente", 30, EntityGrid::TEXT_ALIGN_LEFT ) ;
        $this->addColumn( $column );

		$column = GridModelBuilder::buildColumn( "documento", "cliente.documento", 10, EntityGrid::TEXT_ALIGN_LEFT ) ;
		$this->addColumn( $column );

		$column = GridModelBuilder::buildColumn( "telefono", "cliente.telefono", 30, EntityGrid::TEXT_ALIGN_LEFT ) ;
		$this->addColumn( $column );
