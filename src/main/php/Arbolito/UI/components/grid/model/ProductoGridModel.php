...
use Arbolito\UI\components\grid\formats\GridPrecioListaFormat;
use Arbolito\UI\components\grid\formats\GridPrecioEfectivoFormat;
use Arbolito\UI\components\grid\formats\GridPorcentajeFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	public function getMenuGroups( $item ){
        ...
        if( !$item->getTipoProducto()->getStock() ){

            $menuOption = new MenuActionAjaxOption();
            $menuOption->setLabel( $this->localize( "menu.producto.asignar") );
            $menuOption->setActionName( "AsignarProducto" );
            $menuOption->setConfirmMessage( $this->localize( "producto.asignar.confirm.msg") );
            $menuOption->setConfirmTitle( $this->localize( "producto.asignar.confirm.title") );
            $menuOption->setOnSuccessCallback( "eliminarCallback" );
            $menuOption->addParam("productoOid",$item->getOid());
