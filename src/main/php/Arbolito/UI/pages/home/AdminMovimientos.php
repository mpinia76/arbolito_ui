...
class AdminMovimientos extends ArbolitoPage{
	...
	public function parseSaldos(XTemplate $xtpl){
			...
			$xtpl->assign("saldo_caja", ArbolitoUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoCajaService()->getTotalesDia(new \Datetime())) );
			$xtpl->assign("saldo_ventas", ArbolitoUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoVentaService()->getTotalesDia(new \Datetime())) );

			$criteria = new UIVentaCriteria();
			$criteria->setFecha(new \Datetime());
			$xtpl->assign("saldo_ganancias", ArbolitoUIUtils::formatMontoToView( UIServiceFactory::getUIVentaService()->getGanancias($criteria)) );


			$xtpl->assign("saldo_gastos", ArbolitoUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoGastoService()->getTotalesDia(new \Datetime())) );

			$xtpl->assign("saldo_cajaTarjeta", ArbolitoUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoCajaService()->getTotalesTarjetasDia(new \Datetime())) );
			$xtpl->assign("saldo_cajaCtaCte", ArbolitoUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoCajaService()->getTotalesCtasCtesDia(new \Datetime())) );
