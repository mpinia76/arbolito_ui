<?php
namespace Arbolito\UI\pages\gastos\pagar;
...
class GastoPagar extends ArbolitoPage{
...
//
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "lbl_pendiente", $this->localize( "forma.pago.pendiente") );
			...
			/*$xtpl->assign( "linkPagarEfectivo", $this->getLinkActionPagarGasto($this->getGasto(), ArbolitoUtils::getCuentaUnica(), $this->getBackTo()) );
