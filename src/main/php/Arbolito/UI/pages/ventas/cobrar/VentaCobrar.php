<?php
namespace Arbolito\UI\pages\ventas\cobrar;
...
class VentaCobrar extends ArbolitoPage{
...
//
	...
	protected function parseXTemplate(XTemplate $xtpl){
        ...
        foreach ($bancos as $banco){
            $xtpl->assign( "linkPagarBAPRO", $this->getLinkActionCobrarVenta($this->getVenta(), $banco, $this->getBackTo()) );
