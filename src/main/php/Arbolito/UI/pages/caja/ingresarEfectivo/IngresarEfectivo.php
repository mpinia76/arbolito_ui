<?php
namespace Arbolito\UI\pages\caja\ingresarEfectivo;

use Arbolito\UI\service\UICajaService;
...
class IngresarEfectivo extends ArbolitoPage{
	...
	public function __construct(){
		...
		$this->caja = UIServiceFactory::getUICajaService()->get( ArbolitoUIUtils::getCaja()->getOid() );
