<?php
namespace Arbolito\UI\pages\cuentas\transferir;


use Arbolito\UI\components\filter\model\UICuentaCorrienteCriteria;

use Arbolito\UI\service\UICuentaCorrienteService;

use Arbolito\UI\components\filter\model\UIBancoCriteria;

use Arbolito\UI\components\filter\model\UICuentaSocioCriteria;

use Arbolito\UI\service\UISucursalService;

use Arbolito\UI\components\filter\model\UICuentaCriteria;

use Arbolito\UI\service\finder\CuentaFinder;
...
class Transferir extends ArbolitoPage{
	...
	public function getDestinos(){
		...
		$arbolitoCorrientes = UIServiceFactory::getUICuentaCorrienteService()->getList( new UICuentaCorrienteCriteria());
		...
		$destinos = array_merge($destinos, $arbolitoCorrientes);*/
