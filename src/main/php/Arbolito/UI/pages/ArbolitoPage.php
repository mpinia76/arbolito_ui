 ...
 * @since 01/03/2018
 */
abstract class ArbolitoPage extends RastyPage{
	...
	public function getLinkArbolito(){

		return LinkBuilder::getPageUrl( "Arbolito") ;

	}


    public function getLinkTiposCliente(){

        return LinkBuilder::getPageUrl( "TiposCliente") ;

    }

    public function getLinkTipoClienteAgregar(){

        return LinkBuilder::getPageUrl( "TipoClienteAgregar") ;

    }

    public function getLinkActionAgregarTipoCliente(){

        return LinkBuilder::getActionUrl( "AgregarTipoCliente") ;

    }

    public function getLinkActionModificarTipoCliente(){

        return LinkBuilder::getActionUrl( "ModificarTipoCliente") ;
    ...
    public function getLinkActionCobrarVenta(Venta $venta, Cuenta $cuenta, $backTo ="CajaHome"){



        return LinkBuilder::getActionUrl( "CobrarVenta", array("ventaOid"=>$venta->getOid(),
            "cuentaOid"=>$cuenta->getOid(),
            "backTo" => $backTo)) ;
...
public function getLinkActionPagarPedido(Pedido $pedido, Cuenta $cuenta, $backTo ="CajaHome"){
	...
	public function getLinkVentasPdf(){

		return LinkBuilder::getPdfUrl( "VentasPDF") ;

	}

	public function getLinkVentasXls(){

		return LinkBuilder::getPageUrl( "VentasXLS") ;
