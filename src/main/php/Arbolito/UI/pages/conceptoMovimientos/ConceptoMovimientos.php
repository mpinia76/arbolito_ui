<?php
namespace Arbolito\UI\pages\conceptoMovimientos;

use Arbolito\UI\service\UIServiceFactory;

use Arbolito\UI\components\filter\model\UIConceptoMovimientoCriteria;

use Arbolito\UI\components\grid\model\ConceptoMovimientoGridModel;
 ...
 *
 */
class ConceptoMovimientos extends ArbolitoPage{
