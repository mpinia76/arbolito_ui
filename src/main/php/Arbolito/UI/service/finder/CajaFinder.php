...
use Arbolito\UI\components\filter\model\UICajaCriteria;
...
class CajaFinder implements  IAutocompleteFinder {
	...
	function getEntityLabel( $entity ){
		...
		if( !empty( $entity)  ){
			...
			$params = array( $entity->getNumero(), $entity->getCajero(), ArbolitoUIUtils::formatMontoToView($entity->getSaldo()) );
			return ArbolitoUIUtils::formatMessage( $msg, $params);
		}
